...
public class ScaleView extends View {
    ...
    private void init(Context context) {
        ...
        textPaint.setTextSize(getResources().getDimension(R.dimen.btn_label));
        textPaint.setColor(Color.BLACK);
        goldenPaint = new Paint();
        goldenPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        goldenPaint.setColor(context.getResources().getColor(R.color.bg_screen2));
        ...
        textStartPoint = (int) getResources().getDimension(R.dimen.textview_ruler);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(0f, midScreenPoint - 170, width - 20, midScreenPoint - 170, goldenPaint);
    }
