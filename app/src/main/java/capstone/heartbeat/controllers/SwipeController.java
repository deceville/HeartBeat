...
/**
 * Created by Lenevo on 2/24/2018.
 */
enum ButtonsState {
    GONE,
    LEFT_VISIBLE,
...
public class SwipeController extends ItemTouchHelper.Callback {
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        RectF leftButton = new RectF(itemView.getLeft()+20, itemView.getTop()+20, itemView.getLeft() + buttonWidthWithoutPadding, itemView.getBottom()-20);
        p.setColor(Color.rgb(48, 173, 80));
        ...
        p.setColor(Color.rgb(209, 47, 47));
