...
public class Qrisk2Male {
	...
	/* Sum from interaction terms */
     switch (smoke){
         case 1:a += age_1 * Ismoke[smoke] * 0.6186864699379683900000000;break;
         case 2:a += age_1 * Ismoke[smoke] * 1.5522017055600055000000000;break;
         case 3:a += age_1 * Ismoke[smoke] * 2.4407210657517648000000000;break;
         case 4:a += age_1 * Ismoke[smoke] * 3.5140494491884624000000000;break;
     }
        ...
        switch (smoke){
            case 1:a += age_2 * Ismoke[smoke] *  -0.0040893975066796338000000;break;
            case 2:a += age_2 * Ismoke[smoke] * -0.0056065852346001768000000;break;
            case 3:a += age_2 * Ismoke[smoke] * -0.0018261006189440492000000;break;
            case 4:a += age_2 * Ismoke[smoke] * -0.0014997157296173290000000;break;
        }
